## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Exchange Rates Historical REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Exchange Rates Historical REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | ExchangeRatesHistoricalREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | exchange-rates-historical-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ExchangeRatesHistoricalRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ExchangeRatesHistoricalRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| ExchangeRatesHistoricalREST.Client    | use the "dispatch" functions to send requests       |
| ExchangeRatesHistoricalREST.Core      | core functions, config and request types            |
| ExchangeRatesHistoricalREST.API       | construct api requests                              |
| ExchangeRatesHistoricalREST.Model     | describes api models                                |
| ExchangeRatesHistoricalREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| ExchangeRatesHistoricalREST.ModelLens | lenses for model fields                             |
| ExchangeRatesHistoricalREST.Logging   | logging functions and utils                         |
