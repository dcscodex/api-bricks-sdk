...
module ExchangeRatesHistoricalREST.API.Metadata where
...
v1AssetsAssetIdGet
  ...
  -> ExchangeRatesHistoricalRESTRequest V1AssetsAssetIdGet MimeNoContent [V1Asset] accept
...
v1AssetsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> ExchangeRatesHistoricalRESTRequest V1AssetsGet MimeNoContent [V1Asset] accept
v1AssetsGet  _ =
...
v1AssetsIconsSizeGet
  ...
  -> ExchangeRatesHistoricalRESTRequest V1AssetsIconsSizeGet MimeNoContent [V1Icon] accept
