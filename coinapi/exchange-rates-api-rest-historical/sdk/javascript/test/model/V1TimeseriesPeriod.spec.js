...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExchangeRatesHistoricalRestApi.V1TimeseriesPeriod();
  });
  ...
  describe('V1TimeseriesPeriod', function() {
    it('should create an instance of V1TimeseriesPeriod', function() {
      ...
      //var instance = new ExchangeRatesHistoricalRestApi.V1TimeseriesPeriod();
      //expect(instance).to.be.a(ExchangeRatesHistoricalRestApi.V1TimeseriesPeriod);
    });
