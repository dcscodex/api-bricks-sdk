# api_bricks_coinapi_exchange_rates_api_rest_historical.MetadataApi
...
with api_bricks_coinapi_exchange_rates_api_rest_historical.ApiClient(configuration) as api_client:
    ...
    api_instance = api_bricks_coinapi_exchange_rates_api_rest_historical.MetadataApi(api_client)
