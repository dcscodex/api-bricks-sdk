## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Exchange Rates Realtime REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Exchange Rates Realtime REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | ExchangeRatesRealtimeREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | exchange-rates-realtime-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | ExchangeRatesRealtimeRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | ExchangeRatesRealtimeRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| ExchangeRatesRealtimeREST.Client    | use the "dispatch" functions to send requests       |
| ExchangeRatesRealtimeREST.Core      | core functions, config and request types            |
| ExchangeRatesRealtimeREST.API       | construct api requests                              |
| ExchangeRatesRealtimeREST.Model     | describes api models                                |
| ExchangeRatesRealtimeREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| ExchangeRatesRealtimeREST.ModelLens | lenses for model fields                             |
| ExchangeRatesRealtimeREST.Logging   | logging functions and utils                         |
