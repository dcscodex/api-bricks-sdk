...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ExchangeRatesRealtimeRestApi.V1Asset();
  });
  ...
  describe('V1Asset', function() {
    it('should create an instance of V1Asset', function() {
      ...
      //var instance = new ExchangeRatesRealtimeRestApi.V1Asset();
      //expect(instance).to.be.a(ExchangeRatesRealtimeRestApi.V1Asset);
    });
