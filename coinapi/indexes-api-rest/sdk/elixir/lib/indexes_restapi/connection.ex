...
defmodule IndexesRESTAPI.Connection do
  ...
  - `options`: a keyword list of IndexesRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:indexes_restapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - IndexesRESTAPI 1.0.0 - elixir"
        )
      )
