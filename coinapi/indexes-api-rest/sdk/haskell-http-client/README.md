## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Indexes REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Indexes REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | IndexesREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | indexes-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | IndexesRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | IndexesRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| IndexesREST.Client    | use the "dispatch" functions to send requests       |
| IndexesREST.Core      | core functions, config and request types            |
| IndexesREST.API       | construct api requests                              |
| IndexesREST.Model     | describes api models                                |
| IndexesREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| IndexesREST.ModelLens | lenses for model fields                             |
| IndexesREST.Logging   | logging functions and utils                         |
