## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `CoinAPI Indexes REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the CoinAPI Indexes REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | CoinAPIIndexesREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | coinapi-indexes-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | CoinAPIIndexesRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | CoinAPIIndexesRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| CoinAPIIndexesREST.Client    | use the "dispatch" functions to send requests       |
| CoinAPIIndexesREST.Core      | core functions, config and request types            |
| CoinAPIIndexesREST.API       | construct api requests                              |
| CoinAPIIndexesREST.Model     | describes api models                                |
| CoinAPIIndexesREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| CoinAPIIndexesREST.ModelLens | lenses for model fields                             |
| CoinAPIIndexesREST.Logging   | logging functions and utils                         |
