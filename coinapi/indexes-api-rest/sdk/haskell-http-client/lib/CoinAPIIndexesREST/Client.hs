...
module CoinAPIIndexesREST.Client where
...
dispatchLbs
  ...
  -> CoinAPIIndexesRESTConfig -- ^ config
  -> CoinAPIIndexesRESTRequest req contentType res accept -- ^ request
