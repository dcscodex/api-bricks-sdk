...
module CoinAPIIndexesREST.Core where
...
-- * CoinAPIIndexesRESTConfig

-- |
data CoinAPIIndexesRESTConfig = CoinAPIIndexesRESTConfig
...
-- | display the config
instance P.Show CoinAPIIndexesRESTConfig where
  show c =
    T.printf
...
-- | constructs a default CoinAPIIndexesRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"coinapi-indexes-rest/0.1.0.0"@
--
newConfig :: IO CoinAPIIndexesRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ CoinAPIIndexesRESTConfig
        { configHost = "https://rest-api.indexes.coinapi.io"
        , configUserAgent = "coinapi-indexes-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => CoinAPIIndexesRESTConfig -> auth -> CoinAPIIndexesRESTConfig
addAuthMethod config@CoinAPIIndexesRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: CoinAPIIndexesRESTConfig -> IO CoinAPIIndexesRESTConfig
...
withStderrLogging :: CoinAPIIndexesRESTConfig -> IO CoinAPIIndexesRESTConfig
...
withNoLogging :: CoinAPIIndexesRESTConfig -> CoinAPIIndexesRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * CoinAPIIndexesRESTRequest
...
data CoinAPIIndexesRESTRequest req contentType res accept = CoinAPIIndexesRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of CoinAPIIndexesRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of CoinAPIIndexesRESTRequest
  , rParams   :: Params -- ^ params of CoinAPIIndexesRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (CoinAPIIndexesRESTRequest req contentType res accept) NH.Method
rMethodL f CoinAPIIndexesRESTRequest{..} = (\rMethod -> CoinAPIIndexesRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (CoinAPIIndexesRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f CoinAPIIndexesRESTRequest{..} = (\rUrlPath -> CoinAPIIndexesRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (CoinAPIIndexesRESTRequest req contentType res accept) Params
rParamsL f CoinAPIIndexesRESTRequest{..} = (\rParams -> CoinAPIIndexesRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (CoinAPIIndexesRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f CoinAPIIndexesRESTRequest{..} = (\rAuthTypes -> CoinAPIIndexesRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => CoinAPIIndexesRESTRequest req contentType res accept -> param -> CoinAPIIndexesRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: CoinAPIIndexesRESTRequest req contentType res accept -> param -> CoinAPIIndexesRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: CoinAPIIndexesRESTRequest req contentType res accept -> param -> CoinAPIIndexesRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** CoinAPIIndexesRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> CoinAPIIndexesRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = CoinAPIIndexesRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     CoinAPIIndexesRESTRequest req contentType res accept
  -> [NH.Header]
  -> CoinAPIIndexesRESTRequest req contentType res accept
...
removeHeader :: CoinAPIIndexesRESTRequest req contentType res accept -> [NH.HeaderName] -> CoinAPIIndexesRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => CoinAPIIndexesRESTRequest req contentType res accept -> CoinAPIIndexesRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => CoinAPIIndexesRESTRequest req contentType res accept -> CoinAPIIndexesRESTRequest req contentType res accept
...
addForm :: CoinAPIIndexesRESTRequest req contentType res accept -> WH.Form -> CoinAPIIndexesRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: CoinAPIIndexesRESTRequest req contentType res accept -> NH.Part -> CoinAPIIndexesRESTRequest req contentType res accept
...
_setBodyBS :: CoinAPIIndexesRESTRequest req contentType res accept -> B.ByteString -> CoinAPIIndexesRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: CoinAPIIndexesRESTRequest req contentType res accept -> BL.ByteString -> CoinAPIIndexesRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => CoinAPIIndexesRESTRequest req contentType res accept -> P.Proxy authMethod -> CoinAPIIndexesRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> CoinAPIIndexesRESTRequest req contentType res accept
    -> IO (CoinAPIIndexesRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> CoinAPIIndexesRESTConfig
  -> IO (CoinAPIIndexesRESTRequest req contentType res accept)
_applyAuthMethods req config@(CoinAPIIndexesRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
