...
module IndexesREST.API.Metadata where
...
apiMetadataExchangesExchangeIdGet
  ...
  -> IndexesRESTRequest ApiMetadataExchangesExchangeIdGet MimeNoContent [MetadataExchange] accept
...
apiMetadataExchangesGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> IndexesRESTRequest ApiMetadataExchangesGet MimeNoContent [MetadataExchange] accept
