...
-- |
data IndexesRESTConfig = IndexesRESTConfig
...
-- | display the config
instance P.Show IndexesRESTConfig where
  show c =
    T.printf
...
-- | constructs a default IndexesRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"indexes-rest/0.1.0.0"@
--
newConfig :: IO IndexesRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ IndexesRESTConfig
        { configHost = "https://rest-api.indexes.coinapi.io"
        , configUserAgent = "indexes-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => IndexesRESTConfig -> auth -> IndexesRESTConfig
addAuthMethod config@IndexesRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: IndexesRESTConfig -> IO IndexesRESTConfig
...
withStderrLogging :: IndexesRESTConfig -> IO IndexesRESTConfig
...
withNoLogging :: IndexesRESTConfig -> IndexesRESTConfig
...
data IndexesRESTRequest req contentType res accept = IndexesRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of IndexesRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of IndexesRESTRequest
  , rParams   :: Params -- ^ params of IndexesRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (IndexesRESTRequest req contentType res accept) NH.Method
rMethodL f IndexesRESTRequest{..} = (\rMethod -> IndexesRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (IndexesRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f IndexesRESTRequest{..} = (\rUrlPath -> IndexesRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (IndexesRESTRequest req contentType res accept) Params
rParamsL f IndexesRESTRequest{..} = (\rParams -> IndexesRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (IndexesRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f IndexesRESTRequest{..} = (\rAuthTypes -> IndexesRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => IndexesRESTRequest req contentType res accept -> param -> IndexesRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: IndexesRESTRequest req contentType res accept -> param -> IndexesRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: IndexesRESTRequest req contentType res accept -> param -> IndexesRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** IndexesRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> IndexesRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = IndexesRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     IndexesRESTRequest req contentType res accept
  -> [NH.Header]
  -> IndexesRESTRequest req contentType res accept
...
removeHeader :: IndexesRESTRequest req contentType res accept -> [NH.HeaderName] -> IndexesRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => IndexesRESTRequest req contentType res accept -> IndexesRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => IndexesRESTRequest req contentType res accept -> IndexesRESTRequest req contentType res accept
...
addForm :: IndexesRESTRequest req contentType res accept -> WH.Form -> IndexesRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: IndexesRESTRequest req contentType res accept -> NH.Part -> IndexesRESTRequest req contentType res accept
...
_setBodyBS :: IndexesRESTRequest req contentType res accept -> B.ByteString -> IndexesRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: IndexesRESTRequest req contentType res accept -> BL.ByteString -> IndexesRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => IndexesRESTRequest req contentType res accept -> P.Proxy authMethod -> IndexesRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> IndexesRESTRequest req contentType res accept
    -> IO (IndexesRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> IndexesRESTConfig
  -> IO (IndexesRESTRequest req contentType res accept)
_applyAuthMethods req config@(IndexesRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
