...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IndexesRestApi.MetadataTimeseriesPeriod();
  });
  ...
  describe('MetadataTimeseriesPeriod', function() {
    it('should create an instance of MetadataTimeseriesPeriod', function() {
      // uncomment below and update the code to test MetadataTimeseriesPeriod
      //var instance = new IndexesRestApi.MetadataTimeseriesPeriod();
      //expect(instance).to.be.a(IndexesRestApi.MetadataTimeseriesPeriod);
    });
