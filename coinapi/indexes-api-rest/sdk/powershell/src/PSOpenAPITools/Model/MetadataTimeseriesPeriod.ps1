...
MetadataTimeseriesPeriod<PSCustomObject>
#>

function Initialize-MetadataTimeseriesPeriod {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => MetadataTimeseriesPeriod' | Write-Debug
...
Convert from JSON to MetadataTimeseriesPeriod<PSCustomObject>
...
MetadataTimeseriesPeriod<PSCustomObject>
#>
function ConvertFrom-JsonToMetadataTimeseriesPeriod {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => MetadataTimeseriesPeriod' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in MetadataTimeseriesPeriod
