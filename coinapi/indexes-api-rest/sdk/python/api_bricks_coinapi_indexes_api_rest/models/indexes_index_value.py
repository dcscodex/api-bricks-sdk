...
class IndexesIndexValue(BaseModel):
    """
    IndexesIndexValue
    """ # noqa: E501
    timestamp: Optional[datetime] = None
    value: Optional[Union[StrictFloat, StrictInt]] = None
    composition: Optional[List[IndexesIndexValueComponent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value"),
            "composition": [IndexesIndexValueComponent.from_dict(_item) for _item in obj["composition"]] if obj.get("composition") is not None else None
        })
        return _obj
