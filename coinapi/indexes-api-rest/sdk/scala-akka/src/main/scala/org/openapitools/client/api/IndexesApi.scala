...
class IndexesApi(baseUrl: String) {
   ...
   */
  def v1IndexdefInputDataIndexDefinitionIdAllGet(indexDefinitionId: String)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexDefinitionInputData]] =
   ...
   */
  def v1IndexdefInputDataIndexDefinitionIdGet(indexDefinitionId: String, time: Option[OffsetDateTime] = None, enabledOnly: Option[Boolean] = None, pendingOnly: Option[Boolean] = None, filterAssetId: Option[String] = None, withStatusInfo: Option[Boolean] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexDefinitionSnapshotEntry]] =
   ...
   *   JWT (apiKey)
   */
  def v1IndexdefMultiassetGet()(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexMultiAssetWeight]] =
   ...
   * @param indexId 
   */
  def v1IndexdefMultiassetIndexIdGet(indexId: String)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexMultiAssetWeight]] =
   ...
   *   JWT (apiKey)
   */
  def v1IndexesGet()(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexIdentifier]] =
   ...
   * @param indexDefinitionId 
   */
  def v1IndexesIndexDefinitionIdCurrentSnapshotGet(indexDefinitionId: String)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexDefinitionSnapshotEntry]] =
   ...
   * @param time 
   */
  def v1IndexesIndexDefinitionIdHistorySnapshotGet(indexDefinitionId: String, time: Option[OffsetDateTime] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexDefinitionSnapshotEntry]] =
   ...
   * @param indexId 
   */
  def v1IndexesIndexIdCurrentGet(indexId: String)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[IndexValue] =
   ...
   * @param limit 
   */
  def v1IndexesIndexIdHistoryGet(indexId: String, timeStart: Option[OffsetDateTime] = None, timeEnd: Option[OffsetDateTime] = None, limit: Option[Int] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexValue]] =
   ...
   */
  def v1IndexesIndexIdTimeseriesGet(indexId: String, periodId: String, timeStart: String, timeEnd: String, limit: Option[Int] = None)(implicit apiKey: ApiKeyValue, apiKey: ApiKeyValue): ApiRequest[Seq[IndexTimeseriesItem]] =
