...
package body .Clients is
   ...
   procedure V_1Externalmetrics_Assets_Get
      (Client : in out Client_Type;
       Result : out .Models.V1ExternalAsset_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept (Media_List_1);
      ...
      URI.Set_Path ("/v1/externalmetrics/assets");
      Client.Call (Swagger.Clients.GET, URI, Reply);
      .Models.Deserialize (Reply, "", Result);
   end V_1Externalmetrics_Assets_Get;
   ...
   procedure V_1Externalmetrics_Chains_Get
      (Client : in out Client_Type;
   ...
   begin
      ...
      URI.Set_Path ("/v1/externalmetrics/chains");
      Client.Call (Swagger.Clients.GET, URI, Reply);
      .Models.Deserialize (Reply, "", Result);
   end V_1Externalmetrics_Chains_Get;
   ...
   procedure V_1Externalmetrics_Exchanges_Get
      (Client : in out Client_Type;
       Result : out .Models.V1ExternalExchange_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept (Media_List_1);
      ...
      URI.Set_Path ("/v1/externalmetrics/exchanges");
      Client.Call (Swagger.Clients.GET, URI, Reply);
      .Models.Deserialize (Reply, "", Result);
   end V_1Externalmetrics_Exchanges_Get;
