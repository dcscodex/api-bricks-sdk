...
static bool v1ExternalmetricsAssetsGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(std::list<V1.ExternalAsset>, Error, void* )
	= reinterpret_cast<void(*)(std::list<V1.ExternalAsset>, Error, void* )> (voidHandler);
	
	JsonNode* pJson;
	char * data = p_chunk.memory;

	std::list<V1.ExternalAsset> out;
...
static bool v1ExternalmetricsAssetsGetHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	string url("/v1/externalmetrics/assets");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(ExternalMetricsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = v1ExternalmetricsAssetsGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (ExternalMetricsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), v1ExternalmetricsAssetsGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool ExternalMetricsManager::v1ExternalmetricsAssetsGetAsync(char * accessToken,
	
	void(* handler)(std::list<V1.ExternalAsset>, Error, void* )
	, void* userData)
{
	return v1ExternalmetricsAssetsGetHelper(accessToken,
	
	handler, userData, true);
}

bool ExternalMetricsManager::v1ExternalmetricsAssetsGetSync(char * accessToken,
...
static bool v1ExternalmetricsChainsGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool v1ExternalmetricsChainsGetHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	string url("/v1/externalmetrics/chains");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(ExternalMetricsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = v1ExternalmetricsChainsGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (ExternalMetricsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), v1ExternalmetricsChainsGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool ExternalMetricsManager::v1ExternalmetricsChainsGetAsync(char * accessToken,
	
	void(* handler)(std::list<V1.Chain>, Error, void* )
	, void* userData)
{
	return v1ExternalmetricsChainsGetHelper(accessToken,
	
	handler, userData, true);
}

bool ExternalMetricsManager::v1ExternalmetricsChainsGetSync(char * accessToken,
...
static bool v1ExternalmetricsExchangesGetProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
	void(* handler)(std::list<V1.ExternalExchange>, Error, void* )
	= reinterpret_cast<void(*)(std::list<V1.ExternalExchange>, Error, void* )> (voidHandler);
	
	JsonNode* pJson;
	char * data = p_chunk.memory;

	std::list<V1.ExternalExchange> out;
	...
	if (code >= 200 && code < 300) {
		...
		for(guint i = 0; i < length; i++){
			JsonNode* myJson = json_array_get_element (jsonarray, i);
			char * singlenodestr = json_to_string(myJson, false);
			V1.ExternalExchange singlemodel;
			singlemodel.fromJson(singlenodestr);
			out.push_front(singlemodel);
			g_free(static_cast<gpointer>(singlenodestr));
			json_node_free(myJson);
...
static bool v1ExternalmetricsExchangesGetHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	string url("/v1/externalmetrics/exchanges");
	int pos;
	...
	if(!isAsync){
		NetClient::easycurl(ExternalMetricsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg);
		bool retval = v1ExternalmetricsExchangesGetProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (ExternalMetricsManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), v1ExternalmetricsExchangesGetProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool ExternalMetricsManager::v1ExternalmetricsExchangesGetAsync(char * accessToken,
	
	void(* handler)(std::list<V1.ExternalExchange>, Error, void* )
	, void* userData)
{
	return v1ExternalmetricsExchangesGetHelper(accessToken,
	
	handler, userData, true);
}

bool ExternalMetricsManager::v1ExternalmetricsExchangesGetSync(char * accessToken,
