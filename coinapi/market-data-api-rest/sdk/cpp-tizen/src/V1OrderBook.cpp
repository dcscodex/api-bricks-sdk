...
void
V1.OrderBook::fromJson(char* jsonStr)
{
...
V1.OrderBook::V1.OrderBook(char* json)
{
	this->fromJson(json);
}
...
std::string
V1.OrderBook::getSymbolId()
{
	return symbol_id;
}

void
V1.OrderBook::setSymbolId(std::string  symbol_id)
{
	this->symbol_id = symbol_id;
}

std::string
V1.OrderBook::getTimeExchange()
{
	return time_exchange;
}

void
V1.OrderBook::setTimeExchange(std::string  time_exchange)
{
	this->time_exchange = time_exchange;
}

std::string
V1.OrderBook::getTimeCoinapi()
{
	return time_coinapi;
}

void
V1.OrderBook::setTimeCoinapi(std::string  time_coinapi)
{
	this->time_coinapi = time_coinapi;
}

AnyType
V1.OrderBook::getAsks()
{
	return asks;
}

void
V1.OrderBook::setAsks(AnyType  asks)
{
	this->asks = asks;
}

AnyType
V1.OrderBook::getBids()
{
	return bids;
}

void
V1.OrderBook::setBids(AnyType  bids)
{
	this->bids = bids;
}
