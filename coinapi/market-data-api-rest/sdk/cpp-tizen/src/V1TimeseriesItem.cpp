...
V1.TimeseriesItem::V1.TimeseriesItem()
{
	//__init();
}
...
void
V1.TimeseriesItem::fromJson(char* jsonStr)
{
...
V1.TimeseriesItem::V1.TimeseriesItem(char* json)
{
	this->fromJson(json);
}

char*
V1.TimeseriesItem::toJson()
{
...
std::string
V1.TimeseriesItem::getTimePeriodStart()
{
	return time_period_start;
}

void
V1.TimeseriesItem::setTimePeriodStart(std::string  time_period_start)
{
	this->time_period_start = time_period_start;
}

std::string
V1.TimeseriesItem::getTimePeriodEnd()
{
	return time_period_end;
}

void
V1.TimeseriesItem::setTimePeriodEnd(std::string  time_period_end)
{
	this->time_period_end = time_period_end;
}

std::string
V1.TimeseriesItem::getTimeOpen()
{
	return time_open;
}

void
V1.TimeseriesItem::setTimeOpen(std::string  time_open)
{
	this->time_open = time_open;
}

std::string
V1.TimeseriesItem::getTimeClose()
{
	return time_close;
}

void
V1.TimeseriesItem::setTimeClose(std::string  time_close)
{
	this->time_close = time_close;
}

double
V1.TimeseriesItem::getPriceOpen()
{
	return price_open;
}

void
V1.TimeseriesItem::setPriceOpen(double  price_open)
{
	this->price_open = price_open;
}

double
V1.TimeseriesItem::getPriceHigh()
{
	return price_high;
}

void
V1.TimeseriesItem::setPriceHigh(double  price_high)
{
	this->price_high = price_high;
}

double
V1.TimeseriesItem::getPriceLow()
{
	return price_low;
}

void
V1.TimeseriesItem::setPriceLow(double  price_low)
{
	this->price_low = price_low;
}

double
V1.TimeseriesItem::getPriceClose()
{
	return price_close;
}

void
V1.TimeseriesItem::setPriceClose(double  price_close)
{
	this->price_close = price_close;
}

double
V1.TimeseriesItem::getVolumeTraded()
{
	return volume_traded;
}

void
V1.TimeseriesItem::setVolumeTraded(double  volume_traded)
{
	this->volume_traded = volume_traded;
}

long long
V1.TimeseriesItem::getTradesCount()
{
	return trades_count;
}

void
V1.TimeseriesItem::setTradesCount(long long  trades_count)
{
