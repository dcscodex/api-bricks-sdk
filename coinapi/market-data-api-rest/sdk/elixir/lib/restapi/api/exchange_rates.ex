...
defmodule RESTAPI.Api.ExchangeRates do
  @moduledoc """
  ...
  - `{:ok, RESTAPI.Model.V1ExchangeRate.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_specific_rate(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, RESTAPI.Model.V1ExchangeRate.t} | {:error, Tesla.Env.t}
  def get_specific_rate(connection, asset_id_base, asset_id_quote, opts \\ []) do
    ...
    |> evaluate_response([
      {200, RESTAPI.Model.V1ExchangeRate}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_exchangerate_asset_id_base_asset_id_quote_history_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, [RESTAPI.Model.V1ExchangeRatesTimeseriesItem.t]} | {:error, Tesla.Env.t}
  def v1_exchangerate_asset_id_base_asset_id_quote_history_get(connection, asset_id_base, asset_id_quote, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, RESTAPI.Model.V1ExchangeRatesTimeseriesItem}
    ])
  end
  ...
  - `{:ok, RESTAPI.Model.V1ExchangeRates.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_exchangerate_asset_id_base_get(Tesla.Env.client, String.t, keyword()) :: {:ok, RESTAPI.Model.V1ExchangeRates.t} | {:error, Tesla.Env.t}
  def v1_exchangerate_asset_id_base_get(connection, asset_id_base, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, RESTAPI.Model.V1ExchangeRates}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_exchangerate_history_periods_get(Tesla.Env.client, keyword()) :: {:ok, [RESTAPI.Model.V1TimeseriesPeriod.t]} | {:error, Tesla.Env.t}
