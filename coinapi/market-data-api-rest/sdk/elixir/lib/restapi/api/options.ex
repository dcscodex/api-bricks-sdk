...
defmodule RESTAPI.Api.Options do
  @moduledoc """
  ...
  """
  @spec v1_options_exchange_id_current_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [RESTAPI.Model.OptionsOptionExchangeGroup.t]} | {:error, Tesla.Env.t}
  def v1_options_exchange_id_current_get(connection, exchange_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, RESTAPI.Model.OptionsOptionExchangeGroup}
    ])
  end
end
