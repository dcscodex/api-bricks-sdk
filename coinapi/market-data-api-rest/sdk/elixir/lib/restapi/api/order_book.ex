...
defmodule RESTAPI.Api.OrderBook do
  @moduledoc """
  ...
  - `{:ok, RESTAPI.Model.V1OrderBookBase.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_orderbooks_symbol_id_current_get(Tesla.Env.client, String.t, keyword()) :: {:ok, RESTAPI.Model.V1OrderBookBase.t} | {:error, Tesla.Env.t}
  def v1_orderbooks_symbol_id_current_get(connection, symbol_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, RESTAPI.Model.V1OrderBookBase}
    ])
  end
  ...
  - `{:ok, RESTAPI.Model.V1OrderBookDepth.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_orderbooks_symbol_id_depth_current_get(Tesla.Env.client, String.t, keyword()) :: {:ok, RESTAPI.Model.V1OrderBookDepth.t} | {:error, Tesla.Env.t}
  def v1_orderbooks_symbol_id_depth_current_get(connection, symbol_id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, RESTAPI.Model.V1OrderBookDepth}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_orderbooks_symbol_id_history_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [RESTAPI.Model.V1OrderBook.t]} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_orderbooks_symbol_id_latest_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [RESTAPI.Model.V1OrderBook.t]} | {:error, Tesla.Env.t}
