...
defmodule RESTAPI.Api.OrderBookL3 do
  @moduledoc """
  ...
  """
  @spec v1_orderbooks3_current_get(Tesla.Env.client, keyword()) :: {:ok, [RESTAPI.Model.V1OrderBookBase.t]} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_orderbooks3_symbol_id_current_get(Tesla.Env.client, String.t, keyword()) :: {:ok, RESTAPI.Model.V1OrderBookBase.t} | {:error, Tesla.Env.t}
