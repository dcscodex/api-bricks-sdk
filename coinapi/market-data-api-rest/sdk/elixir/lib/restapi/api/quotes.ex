...
defmodule RESTAPI.Api.Quotes do
  @moduledoc """
  ...
  """
  @spec v1_quotes_current_get(Tesla.Env.client, keyword()) :: {:ok, [RESTAPI.Model.V1QuoteTrade.t]} | {:error, Tesla.Env.t}
  def v1_quotes_current_get(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, RESTAPI.Model.V1QuoteTrade}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_quotes_latest_get(Tesla.Env.client, keyword()) :: {:ok, [RESTAPI.Model.V1Quote.t]} | {:error, Tesla.Env.t}
  ...
  - `{:ok, RESTAPI.Model.V1QuoteTrade.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_quotes_symbol_id_current_get(Tesla.Env.client, String.t, keyword()) :: {:ok, RESTAPI.Model.V1QuoteTrade.t} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_quotes_symbol_id_history_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [RESTAPI.Model.V1Quote.t]} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_quotes_symbol_id_latest_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [RESTAPI.Model.V1Quote.t]} | {:error, Tesla.Env.t}
