...
defmodule RESTAPI.Api.Trades do
  @moduledoc """
  ...
  """
  @spec v1_trades_latest_get(Tesla.Env.client, keyword()) :: {:ok, [RESTAPI.Model.V1Trade.t]} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_trades_symbol_id_history_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [RESTAPI.Model.V1Trade.t]} | {:error, Tesla.Env.t}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec v1_trades_symbol_id_latest_get(Tesla.Env.client, String.t, keyword()) :: {:ok, [RESTAPI.Model.V1Trade.t]} | {:error, Tesla.Env.t}
