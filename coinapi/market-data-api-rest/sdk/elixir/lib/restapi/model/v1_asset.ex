...
defmodule RESTAPI.Model.V1Asset do
  @moduledoc """
  Represents an asset.
  """
  ...
  @type t :: %__MODULE__{
    ...
    :chain_addresses => [RESTAPI.Model.V1ChainNetworkAddress.t] | nil,
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:chain_addresses, :list, RESTAPI.Model.V1ChainNetworkAddress)
  end
end
