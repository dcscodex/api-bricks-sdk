...
module Api.Data exposing
    ...
    , encodeV1ExternalAsset
    , encodeV1ExternalExchange
    , encodeV1GeneralData
    , encodeV1Icon
    , encodeV1LastTrade
    , encodeV1ListingItem
    ...
    , v1ExternalAssetDecoder
    , v1ExternalExchangeDecoder
...
encodeV1ExternalAsset : V1ExternalAsset -> Json.Encode.Value
encodeV1ExternalAsset =
    encodeObject << encodeV1ExternalAssetPairs


encodeV1ExternalAssetWithTag : ( String, String ) -> V1ExternalAsset -> Json.Encode.Value
encodeV1ExternalAssetWithTag (tagField, tag) model =
    encodeObject (encodeV1ExternalAssetPairs model ++ [ encode tagField Json.Encode.string tag ])


encodeV1ExternalAssetPairs : V1ExternalAsset -> List EncodedField
encodeV1ExternalAssetPairs model =
    let
        pairs =
            [ maybeEncodeNullable "asset_id" Json.Encode.string model.assetId
...
encodeV1ExternalExchange : V1ExternalExchange -> Json.Encode.Value
encodeV1ExternalExchange =
    encodeObject << encodeV1ExternalExchangePairs


encodeV1ExternalExchangeWithTag : ( String, String ) -> V1ExternalExchange -> Json.Encode.Value
encodeV1ExternalExchangeWithTag (tagField, tag) model =
    encodeObject (encodeV1ExternalExchangePairs model ++ [ encode tagField Json.Encode.string tag ])


encodeV1ExternalExchangePairs : V1ExternalExchange -> List EncodedField
encodeV1ExternalExchangePairs model =
    let
        pairs =
            [ maybeEncodeNullable "exchange_id" Json.Encode.string model.exchangeId
            , maybeEncodeNullable "external_name" Json.Encode.string model.externalName
            , maybeEncodeNullable "description" Json.Encode.string model.description
...
v1ExternalAssetDecoder : Json.Decode.Decoder V1ExternalAsset
v1ExternalAssetDecoder =
    Json.Decode.succeed V1ExternalAsset
        |> maybeDecodeNullable "asset_id" Json.Decode.string Nothing
        |> maybeDecodeNullable "description" Json.Decode.string Nothing
        |> maybeDecodeNullable "asset_type" Json.Decode.string Nothing


v1ExternalExchangeDecoder : Json.Decode.Decoder V1ExternalExchange
v1ExternalExchangeDecoder =
    Json.Decode.succeed V1ExternalExchange
        |> maybeDecodeNullable "exchange_id" Json.Decode.string Nothing
        |> maybeDecodeNullable "external_name" Json.Decode.string Nothing
        |> maybeDecodeNullable "description" Json.Decode.string Nothing
