...
-}
v1ExchangesExchangeIdGet : String -> Api.Request (List Api.Data.V1Exchange)
v1ExchangesExchangeIdGet exchangeId_path =
    Api.request
        "GET"
...
-}
v1ExchangesGet : Maybe String -> Api.Request (List Api.Data.V1Exchange)
v1ExchangesGet filterExchangeId_query =
    Api.request
        "GET"
        "/v1/exchanges"
        []
...
-}
v1ExchangesIconsSizeGet : Int -> Api.Request (List Api.Data.V1Icon)
v1ExchangesIconsSizeGet size_path =
    Api.request
        "GET"
...
-}
v1SymbolsExchangeIdGet : String -> Maybe String -> Maybe String -> Api.Request (List Api.Data.V1Symbol)
v1SymbolsExchangeIdGet exchangeId_path filterSymbolId_query filterAssetId_query =
    Api.request
        "GET"
...
-}
v1SymbolsGet : Maybe String -> Maybe String -> Maybe String -> Api.Request (List Api.Data.V1Symbol)
v1SymbolsGet filterSymbolId_query filterExchangeId_query filterAssetId_query =
    Api.request
        "GET"
        "/v1/symbols"
        []
...
-}
v1SymbolsMapExchangeIdGet : String -> Api.Request (List Api.Data.V1SymbolMapping)
v1SymbolsMapExchangeIdGet exchangeId_path =
    Api.request
        "GET"
