...
-}
v1OhlcvExchangesExchangeIdHistoryGet : String -> String -> String -> String -> Api.Request (List Api.Data.ModelsExchangeTimeseriesItem)
v1OhlcvExchangesExchangeIdHistoryGet exchangeId_path periodId_query timeStart_query timeEnd_query =
    Api.request
        "GET"
...
-}
v1OhlcvPeriodsGet : Api.Request (List Api.Data.V1TimeseriesPeriod)
v1OhlcvPeriodsGet =
    Api.request
        "GET"
        "/v1/ohlcv/periods"
...
-}
v1OhlcvSymbolIdHistoryGet : String -> String -> Maybe String -> Maybe String -> Maybe Int -> Maybe Bool -> Api.Request (List Api.Data.V1TimeseriesItem)
v1OhlcvSymbolIdHistoryGet symbolId_path periodId_query timeStart_query timeEnd_query limit_query includeEmptyItems_query =
    Api.request
        "GET"
...
-}
v1OhlcvSymbolIdLatestGet : String -> String -> Maybe Int -> Maybe Bool -> Api.Request (List Api.Data.V1TimeseriesItem)
v1OhlcvSymbolIdLatestGet symbolId_path periodId_query limit_query includeEmptyItems_query =
    Api.request
        "GET"
