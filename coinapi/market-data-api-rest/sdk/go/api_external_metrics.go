...
/*
V1ExternalmetricsAssetHistoryGet Historical metrics for the asset from external sources
...
type ApiV1ExternalmetricsAssetsGetRequest struct {
	ctx context.Context
	ApiService *ExternalMetricsAPIService
}

func (r ApiV1ExternalmetricsAssetsGetRequest) Execute() ([]V1ExternalAsset, *http.Response, error) {
	return r.ApiService.V1ExternalmetricsAssetsGetExecute(r)
}
...
Get all assets (primarily stablecoins) supported by external data providers.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiV1ExternalmetricsAssetsGetRequest
*/
func (a *ExternalMetricsAPIService) V1ExternalmetricsAssetsGet(ctx context.Context) ApiV1ExternalmetricsAssetsGetRequest {
	return ApiV1ExternalmetricsAssetsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ExternalMetricsAPIService) V1ExternalmetricsAssetsGetExecute(r ApiV1ExternalmetricsAssetsGetRequest) ([]V1ExternalAsset, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []V1ExternalAsset
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExternalMetricsAPIService.V1ExternalmetricsAssetsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/externalmetrics/assets"
...
type ApiV1ExternalmetricsChainsGetRequest struct {
	ctx context.Context
	ApiService *ExternalMetricsAPIService
}

func (r ApiV1ExternalmetricsChainsGetRequest) Execute() ([]V1Chain, *http.Response, error) {
	return r.ApiService.V1ExternalmetricsChainsGetExecute(r)
}
...
Get all blockchain chains supported by external data providers.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiV1ExternalmetricsChainsGetRequest
*/
func (a *ExternalMetricsAPIService) V1ExternalmetricsChainsGet(ctx context.Context) ApiV1ExternalmetricsChainsGetRequest {
	return ApiV1ExternalmetricsChainsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1Chain
func (a *ExternalMetricsAPIService) V1ExternalmetricsChainsGetExecute(r ApiV1ExternalmetricsChainsGetRequest) ([]V1Chain, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExternalMetricsAPIService.V1ExternalmetricsChainsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/externalmetrics/chains"
...
type ApiV1ExternalmetricsExchangesGetRequest struct {
	ctx context.Context
	ApiService *ExternalMetricsAPIService
}

func (r ApiV1ExternalmetricsExchangesGetRequest) Execute() ([]V1ExternalExchange, *http.Response, error) {
	return r.ApiService.V1ExternalmetricsExchangesGetExecute(r)
}
...
Only returns exchanges that are properly mapped to external protocols for metrics with defined sources.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiV1ExternalmetricsExchangesGetRequest
*/
func (a *ExternalMetricsAPIService) V1ExternalmetricsExchangesGet(ctx context.Context) ApiV1ExternalmetricsExchangesGetRequest {
	return ApiV1ExternalmetricsExchangesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ExternalMetricsAPIService) V1ExternalmetricsExchangesGetExecute(r ApiV1ExternalmetricsExchangesGetRequest) ([]V1ExternalExchange, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []V1ExternalExchange
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ExternalMetricsAPIService.V1ExternalmetricsExchangesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/externalmetrics/exchanges"
...
/*
V1ExternalmetricsListingGet Listing of all supported metrics (both external and generic)
