...
*/
func (a *MetricsAPIService) V1MetricsAssetCurrentGet(ctx context.Context) ApiV1MetricsAssetCurrentGetRequest {
	return ApiV1MetricsAssetCurrentGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MetricsAPIService) V1MetricsAssetCurrentGetExecute(r ApiV1MetricsAssetCurrentGetRequest) ([]V1GeneralData, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsAssetCurrentGet")
	if err != nil {
...
*/
func (a *MetricsAPIService) V1MetricsAssetHistoryGet(ctx context.Context) ApiV1MetricsAssetHistoryGetRequest {
	return ApiV1MetricsAssetHistoryGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1MetricData
func (a *MetricsAPIService) V1MetricsAssetHistoryGetExecute(r ApiV1MetricsAssetHistoryGetRequest) ([]V1MetricData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsAssetHistoryGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsAssetListingGet(ctx context.Context) ApiV1MetricsAssetListingGetRequest {
	return ApiV1MetricsAssetListingGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MetricsAPIService) V1MetricsAssetListingGetExecute(r ApiV1MetricsAssetListingGetRequest) ([]V1ListingItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsAssetListingGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsExchangeCurrentGet(ctx context.Context) ApiV1MetricsExchangeCurrentGetRequest {
	return ApiV1MetricsExchangeCurrentGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1GeneralData
func (a *MetricsAPIService) V1MetricsExchangeCurrentGetExecute(r ApiV1MetricsExchangeCurrentGetRequest) ([]V1GeneralData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsExchangeCurrentGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsExchangeHistoryGet(ctx context.Context) ApiV1MetricsExchangeHistoryGetRequest {
	return ApiV1MetricsExchangeHistoryGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1MetricData
func (a *MetricsAPIService) V1MetricsExchangeHistoryGetExecute(r ApiV1MetricsExchangeHistoryGetRequest) ([]V1MetricData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsExchangeHistoryGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsExchangeListingGet(ctx context.Context) ApiV1MetricsExchangeListingGetRequest {
	return ApiV1MetricsExchangeListingGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1ListingItem
func (a *MetricsAPIService) V1MetricsExchangeListingGetExecute(r ApiV1MetricsExchangeListingGetRequest) ([]V1ListingItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsExchangeListingGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsListingGet(ctx context.Context) ApiV1MetricsListingGetRequest {
	return ApiV1MetricsListingGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1Metric
func (a *MetricsAPIService) V1MetricsListingGetExecute(r ApiV1MetricsListingGetRequest) ([]V1Metric, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsListingGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsSymbolCurrentGet(ctx context.Context) ApiV1MetricsSymbolCurrentGetRequest {
	return ApiV1MetricsSymbolCurrentGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1GeneralData
func (a *MetricsAPIService) V1MetricsSymbolCurrentGetExecute(r ApiV1MetricsSymbolCurrentGetRequest) ([]V1GeneralData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsSymbolCurrentGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsSymbolHistoryGet(ctx context.Context) ApiV1MetricsSymbolHistoryGetRequest {
	return ApiV1MetricsSymbolHistoryGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1MetricData
func (a *MetricsAPIService) V1MetricsSymbolHistoryGetExecute(r ApiV1MetricsSymbolHistoryGetRequest) ([]V1MetricData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsSymbolHistoryGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MetricsAPIService) V1MetricsSymbolListingGet(ctx context.Context) ApiV1MetricsSymbolListingGetRequest {
	return ApiV1MetricsSymbolListingGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []V1ListingItem
func (a *MetricsAPIService) V1MetricsSymbolListingGetExecute(r ApiV1MetricsSymbolListingGetRequest) ([]V1ListingItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetricsAPIService.V1MetricsSymbolListingGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
