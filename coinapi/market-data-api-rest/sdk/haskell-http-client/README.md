## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `CoinAPI Market Data REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the CoinAPI Market Data REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | CoinAPIMarketDataREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | coinapi-market-data-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | CoinAPIMarketDataRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | CoinAPIMarketDataRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| CoinAPIMarketDataREST.Client    | use the "dispatch" functions to send requests       |
| CoinAPIMarketDataREST.Core      | core functions, config and request types            |
| CoinAPIMarketDataREST.API       | construct api requests                              |
| CoinAPIMarketDataREST.Model     | describes api models                                |
| CoinAPIMarketDataREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| CoinAPIMarketDataREST.ModelLens | lenses for model fields                             |
| CoinAPIMarketDataREST.Logging   | logging functions and utils                         |
