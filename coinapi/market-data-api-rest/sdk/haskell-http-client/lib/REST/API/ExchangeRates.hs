...
module REST.API.ExchangeRates where
...
getSpecificRate
  ...
  -> RESTRequest GetSpecificRate MimeNoContent V1ExchangeRate accept
...
v1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet
  ...
  -> RESTRequest V1ExchangerateAssetIdBaseAssetIdQuoteHistoryGet MimeNoContent [V1ExchangeRatesTimeseriesItem] accept
...
v1ExchangerateAssetIdBaseGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> AssetIdBase -- ^ "assetIdBase" -  Requested exchange rates base asset identifier (from the Metadata -> Assets)
  -> RESTRequest V1ExchangerateAssetIdBaseGet MimeNoContent V1ExchangeRates accept
...
v1ExchangerateHistoryPeriodsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> RESTRequest V1ExchangerateHistoryPeriodsGet MimeNoContent [V1TimeseriesPeriod] accept
