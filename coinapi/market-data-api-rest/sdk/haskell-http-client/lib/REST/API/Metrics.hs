...
v1MetricsAssetCurrentGet
  ...
  -> RESTRequest V1MetricsAssetCurrentGet MimeNoContent [V1GeneralData] accept
...
v1MetricsAssetHistoryGet
  ...
  -> RESTRequest V1MetricsAssetHistoryGet MimeNoContent [V1MetricData] accept
...
v1MetricsAssetListingGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> RESTRequest V1MetricsAssetListingGet MimeNoContent [V1ListingItem] accept
...
v1MetricsExchangeCurrentGet
  ...
  -> RESTRequest V1MetricsExchangeCurrentGet MimeNoContent [V1GeneralData] accept
...
v1MetricsExchangeHistoryGet
  ...
  -> MetricId -- ^ "metricId" -  Metric identifier (from the Metrics -> Listing)
  -> ExchangeId -- ^ "exchangeId" -  Exchange identifier (from the Metadata -> Exchanges)
  -> RESTRequest V1MetricsExchangeHistoryGet MimeNoContent [V1MetricData] accept
...
v1MetricsExchangeListingGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> ExchangeId -- ^ "exchangeId" -  The exchange identifier (from the Metadata -> Exchanges)
  -> RESTRequest V1MetricsExchangeListingGet MimeNoContent [V1ListingItem] accept
...
v1MetricsListingGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> RESTRequest V1MetricsListingGet MimeNoContent [V1Metric] accept
...
v1MetricsSymbolCurrentGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> RESTRequest V1MetricsSymbolCurrentGet MimeNoContent [V1GeneralData] accept
...
v1MetricsSymbolHistoryGet
  ...
  -> RESTRequest V1MetricsSymbolHistoryGet MimeNoContent [V1MetricData] accept
...
v1MetricsSymbolListingGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> RESTRequest V1MetricsSymbolListingGet MimeNoContent [V1ListingItem] accept
