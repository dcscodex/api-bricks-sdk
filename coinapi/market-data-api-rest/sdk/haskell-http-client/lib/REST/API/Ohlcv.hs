...
v1OhlcvExchangesExchangeIdHistoryGet
  ...
  -> RESTRequest V1OhlcvExchangesExchangeIdHistoryGet MimeNoContent [ModelsExchangeTimeseriesItem] accept
...
v1OhlcvPeriodsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> RESTRequest V1OhlcvPeriodsGet MimeNoContent [V1TimeseriesPeriod] accept
v1OhlcvPeriodsGet  _ =
...
v1OhlcvSymbolIdHistoryGet
  ...
  -> RESTRequest V1OhlcvSymbolIdHistoryGet MimeNoContent [V1TimeseriesItem] accept
...
v1OhlcvSymbolIdLatestGet
  ...
  -> SymbolId -- ^ "symbolId" -  Symbol identifier of requested timeseries (from the Metadata -> Symbols)
  -> PeriodId -- ^ "periodId" -  Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`)
  -> RESTRequest V1OhlcvSymbolIdLatestGet MimeNoContent [V1TimeseriesItem] accept
