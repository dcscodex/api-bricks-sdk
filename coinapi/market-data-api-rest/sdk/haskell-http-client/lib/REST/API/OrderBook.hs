...
module REST.API.OrderBook where
...
v1OrderbooksSymbolIdCurrentGet
  ...
  -> RESTRequest V1OrderbooksSymbolIdCurrentGet MimeNoContent V1OrderBookBase accept
...
v1OrderbooksSymbolIdDepthCurrentGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> SymbolId -- ^ "symbolId" -  The symbol ID (from the Metadata -> Symbols)
  -> RESTRequest V1OrderbooksSymbolIdDepthCurrentGet MimeNoContent V1OrderBookDepth accept
...
v1OrderbooksSymbolIdHistoryGet
  ...
  -> RESTRequest V1OrderbooksSymbolIdHistoryGet MimeNoContent [V1OrderBook] accept
...
v1OrderbooksSymbolIdLatestGet
  ...
  -> RESTRequest V1OrderbooksSymbolIdLatestGet MimeNoContent [V1OrderBook] accept
