...
data V1ExternalAsset = V1ExternalAsset
  { v1ExternalAssetAssetId :: !(Maybe Text) -- ^ "asset_id" - Gets or sets the asset identifier.
  , v1ExternalAssetDescription :: !(Maybe Text) -- ^ "description" - Gets or sets the description of the asset.
  , v1ExternalAssetAssetType :: !(Maybe Text) -- ^ "asset_type" - Gets or sets the type/category of the asset.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON V1ExternalAsset
instance A.FromJSON V1ExternalAsset where
  parseJSON = A.withObject "V1ExternalAsset" $ \o ->
    V1ExternalAsset
      <$> (o .:? "asset_id")
      <*> (o .:? "description")
      <*> (o .:? "asset_type")

-- | ToJSON V1ExternalAsset
instance A.ToJSON V1ExternalAsset where
  toJSON V1ExternalAsset {..} =
   _omitNulls
      [ "asset_id" .= v1ExternalAssetAssetId
      , "description" .= v1ExternalAssetDescription
      , "asset_type" .= v1ExternalAssetAssetType
      ]


-- | Construct a value of type 'V1ExternalAsset' (by applying it's required fields, if any)
mkV1ExternalAsset
  :: V1ExternalAsset
mkV1ExternalAsset =
  V1ExternalAsset
  { v1ExternalAssetAssetId = Nothing
  , v1ExternalAssetDescription = Nothing
  , v1ExternalAssetAssetType = Nothing
  }

-- ** V1ExternalExchange
-- | V1ExternalExchange
-- Represents an exchange with external mapping for metrics.
data V1ExternalExchange = V1ExternalExchange
  { v1ExternalExchangeExchangeId :: !(Maybe Text) -- ^ "exchange_id" - Gets or sets the internal exchange identifier.
  , v1ExternalExchangeExternalName :: !(Maybe Text) -- ^ "external_name" - Gets or sets the external protocol name/slug.
  , v1ExternalExchangeDescription :: !(Maybe Text) -- ^ "description" - Gets or sets the description of the exchange.
  , v1ExternalExchangeSourceId :: !(Maybe Text) -- ^ "source_id"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON V1ExternalExchange
instance A.FromJSON V1ExternalExchange where
  parseJSON = A.withObject "V1ExternalExchange" $ \o ->
    V1ExternalExchange
      <$> (o .:? "exchange_id")
      <*> (o .:? "external_name")
      <*> (o .:? "description")
...
-- | ToJSON V1ExternalExchange
instance A.ToJSON V1ExternalExchange where
  toJSON V1ExternalExchange {..} =
   _omitNulls
      [ "exchange_id" .= v1ExternalExchangeExchangeId
      , "external_name" .= v1ExternalExchangeExternalName
      , "description" .= v1ExternalExchangeDescription
      , "source_id" .= v1ExternalExchangeSourceId
      ]


-- | Construct a value of type 'V1ExternalExchange' (by applying it's required fields, if any)
mkV1ExternalExchange
  :: V1ExternalExchange
mkV1ExternalExchange =
  V1ExternalExchange
  { v1ExternalExchangeExchangeId = Nothing
  , v1ExternalExchangeExternalName = Nothing
  , v1ExternalExchangeDescription = Nothing
  , v1ExternalExchangeSourceId = Nothing
  }
