...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RestApi.V1ExternalExchange();
  });
  ...
  describe('V1ExternalExchange', function() {
    it('should create an instance of V1ExternalExchange', function() {
      // uncomment below and update the code to test V1ExternalExchange
      //var instance = new RestApi.V1ExternalExchange();
      //expect(instance).to.be.a(RestApi.V1ExternalExchange);
    });
    ...
    it('should have the property externalName (base name: "external_name")', function() {
