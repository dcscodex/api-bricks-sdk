...
class V1ExternalAsset(BaseModel):
    """
    Represents an external asset with description.
    """ # noqa: E501
    asset_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the asset identifier.")
    description: Optional[StrictStr] = Field(default=None, description="Gets or sets the description of the asset.")
    asset_type: Optional[StrictStr] = Field(default=None, description="Gets or sets the type/category of the asset.")
    __properties: ClassVar[List[str]] = ["asset_id", "description", "asset_type"]
