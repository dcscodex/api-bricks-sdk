...
class V1ExternalExchange(BaseModel):
    """
    Represents an exchange with external mapping for metrics.
    """ # noqa: E501
    exchange_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the internal exchange identifier.")
    external_name: Optional[StrictStr] = Field(default=None, description="Gets or sets the external protocol name/slug.")
    description: Optional[StrictStr] = Field(default=None, description="Gets or sets the description of the exchange.")
    source_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["exchange_id", "external_name", "description", "source_id"]
