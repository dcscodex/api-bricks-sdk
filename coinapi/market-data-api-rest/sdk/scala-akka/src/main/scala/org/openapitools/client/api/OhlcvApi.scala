...
class OhlcvApi(baseUrl: String) {
   ...
   */
  def v1OhlcvExchangesExchangeIdHistoryGet(exchangeId: String, periodId: String, timeStart: String, timeEnd: String)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[ExchangeTimeseriesItem]] =
   ...
   *   ApiKey (apiKey)
   */
  def v1OhlcvPeriodsGet()(implicit apiKey: ApiKeyValue): ApiRequest[Seq[TimeseriesPeriod]] =
   ...
   */
  def v1OhlcvSymbolIdHistoryGet(symbolId: String, periodId: String, timeStart: Option[String] = None, timeEnd: Option[String] = None, limit: Option[Int] = None, includeEmptyItems: Option[Boolean] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[TimeseriesItem]] =
   ...
   * @param includeEmptyItems Include items with no activity? (default value is `false`, possible values are `true` or `false`)
   */
  def v1OhlcvSymbolIdLatestGet(symbolId: String, periodId: String, limit: Option[Int] = None, includeEmptyItems: Option[Boolean] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[TimeseriesItem]] =
