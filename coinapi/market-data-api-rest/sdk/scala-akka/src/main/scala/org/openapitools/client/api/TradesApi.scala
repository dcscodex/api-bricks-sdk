...
class TradesApi(baseUrl: String) {
   ...
   */
  def v1TradesLatestGet(filterSymbolId: Option[String] = None, includeId: Option[Boolean] = None, limit: Option[Int] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[Trade]] =
   ...
   * @param includeId Information that additional exchange trade identifier should be included in the `id_trade` parameter of the trade if exchange providing identifiers.
   */
  def v1TradesSymbolIdHistoryGet(symbolId: String, date: Option[String] = None, timeStart: Option[String] = None, timeEnd: Option[String] = None, limit: Option[Int] = None, includeId: Option[Boolean] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[Trade]] =
   ...
   * @param includeId Information that additional exchange trade identifier should be included in the `id_trade` parameter of the trade if exchange providing identifiers.
   */
  def v1TradesSymbolIdLatestGet(symbolId: String, limit: Option[Int] = None, includeId: Option[Boolean] = None)(implicit apiKey: ApiKeyValue): ApiRequest[Seq[Trade]] =
