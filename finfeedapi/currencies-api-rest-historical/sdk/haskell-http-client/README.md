## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `FX Historical REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the FX Historical REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | FXHistoricalREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | fx-historical-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | FXHistoricalRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | FXHistoricalRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| FXHistoricalREST.Client    | use the "dispatch" functions to send requests       |
| FXHistoricalREST.Core      | core functions, config and request types            |
| FXHistoricalREST.API       | construct api requests                              |
| FXHistoricalREST.Model     | describes api models                                |
| FXHistoricalREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| FXHistoricalREST.ModelLens | lenses for model fields                             |
| FXHistoricalREST.Logging   | logging functions and utils                         |
