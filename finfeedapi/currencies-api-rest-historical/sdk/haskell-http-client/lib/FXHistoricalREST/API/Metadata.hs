...
module FXHistoricalREST.API.Metadata where
...
v1AssetsAssetIdGet
  ...
  -> FXHistoricalRESTRequest V1AssetsAssetIdGet MimeNoContent [V1Asset] accept
...
v1AssetsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> FXHistoricalRESTRequest V1AssetsGet MimeNoContent [V1Asset] accept
v1AssetsGet  _ =
...
v1AssetsIconsSizeGet
  ...
  -> FXHistoricalRESTRequest V1AssetsIconsSizeGet MimeNoContent [V1Icon] accept
