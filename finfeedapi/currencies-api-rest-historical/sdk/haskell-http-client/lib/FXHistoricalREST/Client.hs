...
module FXHistoricalREST.Client where
...
dispatchLbs
  ...
  -> FXHistoricalRESTConfig -- ^ config
  -> FXHistoricalRESTRequest req contentType res accept -- ^ request
