...
module FXHistoricalREST.Core where
...
-- * FXHistoricalRESTConfig

-- |
data FXHistoricalRESTConfig = FXHistoricalRESTConfig
...
-- | display the config
instance P.Show FXHistoricalRESTConfig where
  show c =
    T.printf
...
-- | constructs a default FXHistoricalRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"fx-historical-rest/0.1.0.0"@
--
newConfig :: IO FXHistoricalRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ FXHistoricalRESTConfig
        { configHost = "https://api-historical.fx.finfeedapi.com"
        , configUserAgent = "fx-historical-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => FXHistoricalRESTConfig -> auth -> FXHistoricalRESTConfig
addAuthMethod config@FXHistoricalRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: FXHistoricalRESTConfig -> IO FXHistoricalRESTConfig
...
withStderrLogging :: FXHistoricalRESTConfig -> IO FXHistoricalRESTConfig
...
withNoLogging :: FXHistoricalRESTConfig -> FXHistoricalRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * FXHistoricalRESTRequest
...
data FXHistoricalRESTRequest req contentType res accept = FXHistoricalRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of FXHistoricalRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of FXHistoricalRESTRequest
  , rParams   :: Params -- ^ params of FXHistoricalRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (FXHistoricalRESTRequest req contentType res accept) NH.Method
rMethodL f FXHistoricalRESTRequest{..} = (\rMethod -> FXHistoricalRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (FXHistoricalRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f FXHistoricalRESTRequest{..} = (\rUrlPath -> FXHistoricalRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (FXHistoricalRESTRequest req contentType res accept) Params
rParamsL f FXHistoricalRESTRequest{..} = (\rParams -> FXHistoricalRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (FXHistoricalRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f FXHistoricalRESTRequest{..} = (\rAuthTypes -> FXHistoricalRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => FXHistoricalRESTRequest req contentType res accept -> param -> FXHistoricalRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: FXHistoricalRESTRequest req contentType res accept -> param -> FXHistoricalRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: FXHistoricalRESTRequest req contentType res accept -> param -> FXHistoricalRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** FXHistoricalRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> FXHistoricalRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = FXHistoricalRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     FXHistoricalRESTRequest req contentType res accept
  -> [NH.Header]
  -> FXHistoricalRESTRequest req contentType res accept
...
removeHeader :: FXHistoricalRESTRequest req contentType res accept -> [NH.HeaderName] -> FXHistoricalRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => FXHistoricalRESTRequest req contentType res accept -> FXHistoricalRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => FXHistoricalRESTRequest req contentType res accept -> FXHistoricalRESTRequest req contentType res accept
...
addForm :: FXHistoricalRESTRequest req contentType res accept -> WH.Form -> FXHistoricalRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: FXHistoricalRESTRequest req contentType res accept -> NH.Part -> FXHistoricalRESTRequest req contentType res accept
...
_setBodyBS :: FXHistoricalRESTRequest req contentType res accept -> B.ByteString -> FXHistoricalRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: FXHistoricalRESTRequest req contentType res accept -> BL.ByteString -> FXHistoricalRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => FXHistoricalRESTRequest req contentType res accept -> P.Proxy authMethod -> FXHistoricalRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> FXHistoricalRESTRequest req contentType res accept
    -> IO (FXHistoricalRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> FXHistoricalRESTConfig
  -> IO (FXHistoricalRESTRequest req contentType res accept)
_applyAuthMethods req config@(FXHistoricalRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
