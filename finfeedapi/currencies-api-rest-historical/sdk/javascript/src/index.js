...
* <pre>
* var FxHistoricalRestApi = require('index'); // See note below*.
* var xxxSvc = new FxHistoricalRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new FxHistoricalRestApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new FxHistoricalRestApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new FxHistoricalRestApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
