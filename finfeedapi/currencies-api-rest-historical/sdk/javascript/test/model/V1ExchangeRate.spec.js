...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FxHistoricalRestApi.V1ExchangeRate();
  });
  ...
  describe('V1ExchangeRate', function() {
    it('should create an instance of V1ExchangeRate', function() {
      ...
      //var instance = new FxHistoricalRestApi.V1ExchangeRate();
      //expect(instance).to.be.a(FxHistoricalRestApi.V1ExchangeRate);
    });
