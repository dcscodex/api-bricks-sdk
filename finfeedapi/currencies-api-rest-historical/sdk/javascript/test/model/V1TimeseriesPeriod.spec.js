...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FxHistoricalRestApi.V1TimeseriesPeriod();
  });
  ...
  describe('V1TimeseriesPeriod', function() {
    it('should create an instance of V1TimeseriesPeriod', function() {
      ...
      //var instance = new FxHistoricalRestApi.V1TimeseriesPeriod();
      //expect(instance).to.be.a(FxHistoricalRestApi.V1TimeseriesPeriod);
    });
