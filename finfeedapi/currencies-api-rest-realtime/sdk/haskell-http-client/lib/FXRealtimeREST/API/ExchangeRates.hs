...
module FXRealtimeREST.API.ExchangeRates where
...
getSpecificRate
  ...
  -> FXRealtimeRESTRequest GetSpecificRate MimeNoContent V1ExchangeRate accept
...
v1ExchangerateAssetIdBaseGet
  ...
  -> FXRealtimeRESTRequest V1ExchangerateAssetIdBaseGet MimeNoContent V1ExchangeRates accept
