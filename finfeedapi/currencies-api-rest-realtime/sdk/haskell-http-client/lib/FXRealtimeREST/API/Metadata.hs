...
module FXRealtimeREST.API.Metadata where
...
v1AssetsAssetIdGet
  ...
  -> FXRealtimeRESTRequest V1AssetsAssetIdGet MimeNoContent [V1Asset] accept
...
v1AssetsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> FXRealtimeRESTRequest V1AssetsGet MimeNoContent [V1Asset] accept
v1AssetsGet  _ =
...
v1AssetsIconsSizeGet
  ...
  -> FXRealtimeRESTRequest V1AssetsIconsSizeGet MimeNoContent [V1Icon] accept
