...
module FXRealtimeREST.Client where
...
dispatchLbs
  ...
  -> FXRealtimeRESTConfig -- ^ config
  -> FXRealtimeRESTRequest req contentType res accept -- ^ request
