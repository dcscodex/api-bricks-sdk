...
module FXRealtimeREST.Core where
...
-- * FXRealtimeRESTConfig

-- |
data FXRealtimeRESTConfig = FXRealtimeRESTConfig
...
-- | display the config
instance P.Show FXRealtimeRESTConfig where
  show c =
    T.printf
...
-- | constructs a default FXRealtimeRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"fx-realtime-rest/0.1.0.0"@
--
newConfig :: IO FXRealtimeRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ FXRealtimeRESTConfig
        { configHost = "https://api-realtime.fx.finfeedapi.com"
        , configUserAgent = "fx-realtime-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => FXRealtimeRESTConfig -> auth -> FXRealtimeRESTConfig
addAuthMethod config@FXRealtimeRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: FXRealtimeRESTConfig -> IO FXRealtimeRESTConfig
...
withStderrLogging :: FXRealtimeRESTConfig -> IO FXRealtimeRESTConfig
...
withNoLogging :: FXRealtimeRESTConfig -> FXRealtimeRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * FXRealtimeRESTRequest
...
data FXRealtimeRESTRequest req contentType res accept = FXRealtimeRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of FXRealtimeRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of FXRealtimeRESTRequest
  , rParams   :: Params -- ^ params of FXRealtimeRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (FXRealtimeRESTRequest req contentType res accept) NH.Method
rMethodL f FXRealtimeRESTRequest{..} = (\rMethod -> FXRealtimeRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (FXRealtimeRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f FXRealtimeRESTRequest{..} = (\rUrlPath -> FXRealtimeRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (FXRealtimeRESTRequest req contentType res accept) Params
rParamsL f FXRealtimeRESTRequest{..} = (\rParams -> FXRealtimeRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (FXRealtimeRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f FXRealtimeRESTRequest{..} = (\rAuthTypes -> FXRealtimeRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => FXRealtimeRESTRequest req contentType res accept -> param -> FXRealtimeRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: FXRealtimeRESTRequest req contentType res accept -> param -> FXRealtimeRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: FXRealtimeRESTRequest req contentType res accept -> param -> FXRealtimeRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** FXRealtimeRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> FXRealtimeRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = FXRealtimeRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     FXRealtimeRESTRequest req contentType res accept
  -> [NH.Header]
  -> FXRealtimeRESTRequest req contentType res accept
...
removeHeader :: FXRealtimeRESTRequest req contentType res accept -> [NH.HeaderName] -> FXRealtimeRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => FXRealtimeRESTRequest req contentType res accept -> FXRealtimeRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => FXRealtimeRESTRequest req contentType res accept -> FXRealtimeRESTRequest req contentType res accept
...
addForm :: FXRealtimeRESTRequest req contentType res accept -> WH.Form -> FXRealtimeRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: FXRealtimeRESTRequest req contentType res accept -> NH.Part -> FXRealtimeRESTRequest req contentType res accept
...
_setBodyBS :: FXRealtimeRESTRequest req contentType res accept -> B.ByteString -> FXRealtimeRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: FXRealtimeRESTRequest req contentType res accept -> BL.ByteString -> FXRealtimeRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => FXRealtimeRESTRequest req contentType res accept -> P.Proxy authMethod -> FXRealtimeRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> FXRealtimeRESTRequest req contentType res accept
    -> IO (FXRealtimeRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> FXRealtimeRESTConfig
  -> IO (FXRealtimeRESTRequest req contentType res accept)
_applyAuthMethods req config@(FXRealtimeRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
