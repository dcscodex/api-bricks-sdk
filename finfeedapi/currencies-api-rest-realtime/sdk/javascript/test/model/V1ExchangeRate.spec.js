...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FxRealtimeRestApi.V1ExchangeRate();
  });
  ...
  describe('V1ExchangeRate', function() {
    it('should create an instance of V1ExchangeRate', function() {
      ...
      //var instance = new FxRealtimeRestApi.V1ExchangeRate();
      //expect(instance).to.be.a(FxRealtimeRestApi.V1ExchangeRate);
    });
