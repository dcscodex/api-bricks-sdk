#ifndef _XBRLConversionManager_H_
#define _XBRLConversionManager_H_
...
/** \addtogroup XBRLConversion XBRLConversion
 * \ingroup Operations
 *  @{
 */
class XBRLConversionManager {
public:
	XBRLConversionManager();
	virtual ~XBRLConversionManager();
...
#endif /* XBRLConversionManager_H_ */
