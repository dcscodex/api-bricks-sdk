...
[assembly: InternalsVisibleTo("APIBricks.FinFeedAPI.SECAPI.REST.V1.Test")]
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is DTOExtractorType dTOExtractorType)
                return DTOExtractorTypeValueConverter.ToJsonValue(dTOExtractorType);
            if (obj is DTOFilingSortBy dTOFilingSortBy)
                return DTOFilingSortByValueConverter.ToJsonValue(dTOFilingSortBy);
