...
defmodule FinFeedAPISECRESTAPI.Connection do
  ...
  - `options`: a keyword list of FinFeedAPISECRESTAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:fin_feed_apisecrestapi, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - FinFeedAPISECRESTAPI 1.0.0 - elixir"
        )
      )
