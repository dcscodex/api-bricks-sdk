...
defmodule FinFeedAPISECRESTAPI.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    FinFeedAPISECRESTAPI.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    FinFeedAPISECRESTAPI.Deserializer.json_decode(body, module)
  end
end
