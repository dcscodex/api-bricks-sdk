...
-spec v1_extractor_get(ctx:ctx(), binary(), maps:map()) -> {ok, openapi_d_to_filing_extract_result_dto:openapi_d_to_filing_extract_result_dto(), openapi_utils:response_info()} | {ok, hackney:client_ref()} | {error, term(), openapi_utils:response_info()}.
