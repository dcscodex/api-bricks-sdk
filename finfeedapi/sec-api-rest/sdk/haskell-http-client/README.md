## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `FinFeedAPI SEC REST API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the FinFeedAPI SEC REST API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | FinFeedAPISECREST                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | finfeedapi-sec-rest                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | FinFeedAPISECRESTConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | FinFeedAPISECRESTRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| FinFeedAPISECREST.Client    | use the "dispatch" functions to send requests       |
| FinFeedAPISECREST.Core      | core functions, config and request types            |
| FinFeedAPISECREST.API       | construct api requests                              |
| FinFeedAPISECREST.Model     | describes api models                                |
| FinFeedAPISECREST.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| FinFeedAPISECREST.ModelLens | lenses for model fields                             |
| FinFeedAPISECREST.Logging   | logging functions and utils                         |
