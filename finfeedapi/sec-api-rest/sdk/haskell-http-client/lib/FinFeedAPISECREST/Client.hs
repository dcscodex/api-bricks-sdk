...
module FinFeedAPISECREST.Client where
...
dispatchLbs
  ...
  -> FinFeedAPISECRESTConfig -- ^ config
  -> FinFeedAPISECRESTRequest req contentType res accept -- ^ request
