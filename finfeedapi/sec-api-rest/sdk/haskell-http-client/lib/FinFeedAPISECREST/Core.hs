...
module FinFeedAPISECREST.Core where
...
-- * FinFeedAPISECRESTConfig

-- |
data FinFeedAPISECRESTConfig = FinFeedAPISECRESTConfig
...
-- | display the config
instance P.Show FinFeedAPISECRESTConfig where
  show c =
    T.printf
...
-- | constructs a default FinFeedAPISECRESTConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"finfeedapi-sec-rest/0.1.0.0"@
--
newConfig :: IO FinFeedAPISECRESTConfig
newConfig = do
    logCxt <- initLogContext
    return $ FinFeedAPISECRESTConfig
        { configHost = "https://api.sec.finfeedapi.com"
        , configUserAgent = "finfeedapi-sec-rest/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => FinFeedAPISECRESTConfig -> auth -> FinFeedAPISECRESTConfig
addAuthMethod config@FinFeedAPISECRESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: FinFeedAPISECRESTConfig -> IO FinFeedAPISECRESTConfig
...
withStderrLogging :: FinFeedAPISECRESTConfig -> IO FinFeedAPISECRESTConfig
...
withNoLogging :: FinFeedAPISECRESTConfig -> FinFeedAPISECRESTConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * FinFeedAPISECRESTRequest
...
data FinFeedAPISECRESTRequest req contentType res accept = FinFeedAPISECRESTRequest
  { rMethod  :: NH.Method   -- ^ Method of FinFeedAPISECRESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of FinFeedAPISECRESTRequest
  , rParams   :: Params -- ^ params of FinFeedAPISECRESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (FinFeedAPISECRESTRequest req contentType res accept) NH.Method
rMethodL f FinFeedAPISECRESTRequest{..} = (\rMethod -> FinFeedAPISECRESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (FinFeedAPISECRESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f FinFeedAPISECRESTRequest{..} = (\rUrlPath -> FinFeedAPISECRESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (FinFeedAPISECRESTRequest req contentType res accept) Params
rParamsL f FinFeedAPISECRESTRequest{..} = (\rParams -> FinFeedAPISECRESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (FinFeedAPISECRESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f FinFeedAPISECRESTRequest{..} = (\rAuthTypes -> FinFeedAPISECRESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => FinFeedAPISECRESTRequest req contentType res accept -> param -> FinFeedAPISECRESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: FinFeedAPISECRESTRequest req contentType res accept -> param -> FinFeedAPISECRESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: FinFeedAPISECRESTRequest req contentType res accept -> param -> FinFeedAPISECRESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** FinFeedAPISECRESTRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> FinFeedAPISECRESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = FinFeedAPISECRESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     FinFeedAPISECRESTRequest req contentType res accept
  -> [NH.Header]
  -> FinFeedAPISECRESTRequest req contentType res accept
...
removeHeader :: FinFeedAPISECRESTRequest req contentType res accept -> [NH.HeaderName] -> FinFeedAPISECRESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => FinFeedAPISECRESTRequest req contentType res accept -> FinFeedAPISECRESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => FinFeedAPISECRESTRequest req contentType res accept -> FinFeedAPISECRESTRequest req contentType res accept
...
addForm :: FinFeedAPISECRESTRequest req contentType res accept -> WH.Form -> FinFeedAPISECRESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: FinFeedAPISECRESTRequest req contentType res accept -> NH.Part -> FinFeedAPISECRESTRequest req contentType res accept
...
_setBodyBS :: FinFeedAPISECRESTRequest req contentType res accept -> B.ByteString -> FinFeedAPISECRESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: FinFeedAPISECRESTRequest req contentType res accept -> BL.ByteString -> FinFeedAPISECRESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => FinFeedAPISECRESTRequest req contentType res accept -> P.Proxy authMethod -> FinFeedAPISECRESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> FinFeedAPISECRESTRequest req contentType res accept
    -> IO (FinFeedAPISECRESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> FinFeedAPISECRESTConfig
  -> IO (FinFeedAPISECRESTRequest req contentType res accept)
_applyAuthMethods req config@(FinFeedAPISECRESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
