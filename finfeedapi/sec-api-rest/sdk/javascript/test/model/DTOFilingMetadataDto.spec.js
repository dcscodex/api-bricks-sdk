...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FinFeedApiSecRestApi.DTOFilingMetadataDto();
  });
  ...
  describe('DTOFilingMetadataDto', function() {
    it('should create an instance of DTOFilingMetadataDto', function() {
      ...
      //var instance = new FinFeedApiSecRestApi.DTOFilingMetadataDto();
      //expect(instance).to.be.a(FinFeedApiSecRestApi.DTOFilingMetadataDto);
    });
