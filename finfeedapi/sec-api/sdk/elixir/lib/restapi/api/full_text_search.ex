...
defmodule RESTAPI.Api.FullTextSearch do
  @moduledoc """
  ...
  """
  @spec v1_full_text_get(Tesla.Env.client, keyword()) :: {:ok, RESTAPI.Model.MvcValidationProblemDetails.t} | {:ok, [RESTAPI.Model.DtoSecFilingResultDto.t]} | {:ok, RESTAPI.Model.MvcProblemDetails.t} | {:error, Tesla.Env.t}
  def v1_full_text_get(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, RESTAPI.Model.DtoSecFilingResultDto},
