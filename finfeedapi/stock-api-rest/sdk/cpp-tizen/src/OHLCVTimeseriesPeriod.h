/*
 * OHLCV.TimeseriesPeriod.h
 *
 * Represents a timeseries period used in exchange rate data.
 */

#ifndef _OHLCV.TimeseriesPeriod_H_
#define _OHLCV.TimeseriesPeriod_H_
...
class OHLCV.TimeseriesPeriod : public Object {
public:
	/*! \brief Constructor.
	 */
	OHLCV.TimeseriesPeriod();
	OHLCV.TimeseriesPeriod(char* str);

	/*! \brief Destructor.
	 */
	virtual ~OHLCV.TimeseriesPeriod();
...
#endif /* _OHLCV.TimeseriesPeriod_H_ */
