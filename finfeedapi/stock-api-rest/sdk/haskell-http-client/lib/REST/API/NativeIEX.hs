...
module REST.API.NativeIEX where
...
v1NativeIexAdminMessagesSymbolGet
  ...
  -> RESTRequest V1NativeIexAdminMessagesSymbolGet MimeNoContent [AdminAdminMessageModel] MimeJSON
...
v1NativeIexAdminSystemEventGet
  ...
  -> RESTRequest V1NativeIexAdminSystemEventGet MimeNoContent [AdminSystemEventModel] MimeJSON
...
v1NativeIexLevel1QuoteSymbolGet
  :: Symbol -- ^ "symbol" -  The symbol identifier
  -> ParamDate -- ^ "date" -  Optional date in format YYYY-MM-DD (defaults to latest available data)
  -> RESTRequest V1NativeIexLevel1QuoteSymbolGet MimeNoContent [Level1QuoteUpdateModel] MimeJSON
...
v1NativeIexLevel2PriceLevelUpdateSymbolGet
  :: Symbol -- ^ "symbol" -  The symbol identifier
  -> ParamDate -- ^ "date" -  Optional date in format YYYY-MM-DD (defaults to latest available data)
  -> RESTRequest V1NativeIexLevel2PriceLevelUpdateSymbolGet MimeNoContent [Level2PriceLevelUpdateModel] MimeJSON
...
v1NativeIexLevel3OrderBookSymbolGet
  :: Symbol -- ^ "symbol" -  The symbol identifier
  -> ParamDate -- ^ "date" -  Optional date in format YYYY-MM-DD (defaults to latest available data)
  -> RESTRequest V1NativeIexLevel3OrderBookSymbolGet MimeNoContent [Level3OrderBookModel] MimeJSON
...
v1NativeIexTradeSymbolGet
  :: Symbol -- ^ "symbol" -  The symbol identifier
  -> ParamDate -- ^ "date" -  Optional date in format YYYY-MM-DD (defaults to latest available data)
  -> RESTRequest V1NativeIexTradeSymbolGet MimeNoContent [TradeTradeModel] MimeJSON
