...
v1OhlcvExchangeExchangeIdHistoryGet
  ...
  -> RESTRequest V1OhlcvExchangeExchangeIdHistoryGet MimeNoContent [OHLCVExchangeTimeseriesItem] accept
...
v1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGet
  ...
  -> RESTRequest V1OhlcvExchangeSymbolExchangeIdSymbolIdHistoryGet MimeNoContent [OHLCVTimeseriesItem] accept
...
v1OhlcvExchangeSymbolExchangeIdSymbolIdLatestGet
  ...
  -> SymbolId -- ^ "symbolId" -  Symbol identifier of requested timeseries (from the Metadata -> Symbols)
  -> PeriodId -- ^ "periodId" -  Identifier of requested timeseries period (e.g. `5SEC` or `2MTH`)
  -> RESTRequest V1OhlcvExchangeSymbolExchangeIdSymbolIdLatestGet MimeNoContent [OHLCVTimeseriesItem] accept
...
v1OhlcvPeriodsGet
  :: Accept accept -- ^ request accept ('MimeType')
  -> RESTRequest V1OhlcvPeriodsGet MimeNoContent [OHLCVTimeseriesPeriod] accept
v1OhlcvPeriodsGet  _ =
