...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RestApi.AdminSecurityDirectoryModel();
  });
  ...
  describe('AdminSecurityDirectoryModel', function() {
    it('should create an instance of AdminSecurityDirectoryModel', function() {
      ...
      //var instance = new RestApi.AdminSecurityDirectoryModel();
      //expect(instance).to.be.a(RestApi.AdminSecurityDirectoryModel);
    });
