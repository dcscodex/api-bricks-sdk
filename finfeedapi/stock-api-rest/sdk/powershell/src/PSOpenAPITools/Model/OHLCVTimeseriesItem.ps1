...
OHLCVTimeseriesItem<PSCustomObject>
#>

function Initialize-OHLCVTimeseriesItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OHLCVTimeseriesItem' | Write-Debug
...
Convert from JSON to OHLCVTimeseriesItem<PSCustomObject>
...
OHLCVTimeseriesItem<PSCustomObject>
#>
function ConvertFrom-JsonToOHLCVTimeseriesItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OHLCVTimeseriesItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OHLCVTimeseriesItem
