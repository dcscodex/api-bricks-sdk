...
namespace APIBricks.FinFeedAPI.STOCKAPI.REST.V1.Model
{
    ...
    /// </summary>
    public partial class OHLCVTimeseriesItem : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OHLCVTimeseriesItem" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public OHLCVTimeseriesItem(Option<DateTime?> timePeriodStart = default, Option<DateTime?> timePeriodEnd = default, Option<DateTime?> timeOpen = default, Option<DateTime?> timeClose = default, Option<double?> priceOpen = default, Option<double?> priceHigh = default, Option<double?> priceLow = default, Option<double?> priceClose = default, Option<double?> volumeTraded = default, Option<long?> tradesCount = default)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="OHLCVTimeseriesItem" />
    /// </summary>
    public class OHLCVTimeseriesItemJsonConverter : JsonConverter<OHLCVTimeseriesItem>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="OHLCVTimeseriesItem" />
        /// </summary>
        ...
        public override OHLCVTimeseriesItem Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (timePeriodStart.IsSet && timePeriodStart.Value == null)
                throw new ArgumentNullException(nameof(timePeriodStart), "Property is not nullable for class OHLCVTimeseriesItem.");

            if (timePeriodEnd.IsSet && timePeriodEnd.Value == null)
                throw new ArgumentNullException(nameof(timePeriodEnd), "Property is not nullable for class OHLCVTimeseriesItem.");

            if (volumeTraded.IsSet && volumeTraded.Value == null)
                throw new ArgumentNullException(nameof(volumeTraded), "Property is not nullable for class OHLCVTimeseriesItem.");

            if (tradesCount.IsSet && tradesCount.Value == null)
                throw new ArgumentNullException(nameof(tradesCount), "Property is not nullable for class OHLCVTimeseriesItem.");

            return new OHLCVTimeseriesItem(timePeriodStart, timePeriodEnd, timeOpen, timeClose, priceOpen, priceHigh, priceLow, priceClose, volumeTraded, tradesCount);
        }

        /// <summary>
        /// Serializes a <see cref="OHLCVTimeseriesItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="oHLCVTimeseriesItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, OHLCVTimeseriesItem oHLCVTimeseriesItem, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, oHLCVTimeseriesItem, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="OHLCVTimeseriesItem" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="oHLCVTimeseriesItem"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, OHLCVTimeseriesItem oHLCVTimeseriesItem, JsonSerializerOptions jsonSerializerOptions)
        {
            if (oHLCVTimeseriesItem.TimePeriodStartOption.IsSet)
                writer.WriteString("time_period_start", oHLCVTimeseriesItem.TimePeriodStartOption.Value!.Value.ToString(TimePeriodStartFormat));

            if (oHLCVTimeseriesItem.TimePeriodEndOption.IsSet)
                writer.WriteString("time_period_end", oHLCVTimeseriesItem.TimePeriodEndOption.Value!.Value.ToString(TimePeriodEndFormat));

            if (oHLCVTimeseriesItem.TimeOpenOption.IsSet)
                if (oHLCVTimeseriesItem.TimeOpenOption.Value != null)
                    writer.WriteString("time_open", oHLCVTimeseriesItem.TimeOpenOption.Value!.Value.ToString(TimeOpenFormat));
                else
                    writer.WriteNull("time_open");

            if (oHLCVTimeseriesItem.TimeCloseOption.IsSet)
                if (oHLCVTimeseriesItem.TimeCloseOption.Value != null)
                    writer.WriteString("time_close", oHLCVTimeseriesItem.TimeCloseOption.Value!.Value.ToString(TimeCloseFormat));
                else
                    writer.WriteNull("time_close");

            if (oHLCVTimeseriesItem.PriceOpenOption.IsSet)
                if (oHLCVTimeseriesItem.PriceOpenOption.Value != null)
                    writer.WriteNumber("price_open", oHLCVTimeseriesItem.PriceOpenOption.Value!.Value);
                else
                    writer.WriteNull("price_open");

            if (oHLCVTimeseriesItem.PriceHighOption.IsSet)
                if (oHLCVTimeseriesItem.PriceHighOption.Value != null)
                    writer.WriteNumber("price_high", oHLCVTimeseriesItem.PriceHighOption.Value!.Value);
                else
                    writer.WriteNull("price_high");

            if (oHLCVTimeseriesItem.PriceLowOption.IsSet)
                if (oHLCVTimeseriesItem.PriceLowOption.Value != null)
                    writer.WriteNumber("price_low", oHLCVTimeseriesItem.PriceLowOption.Value!.Value);
                else
                    writer.WriteNull("price_low");

            if (oHLCVTimeseriesItem.PriceCloseOption.IsSet)
                if (oHLCVTimeseriesItem.PriceCloseOption.Value != null)
                    writer.WriteNumber("price_close", oHLCVTimeseriesItem.PriceCloseOption.Value!.Value);
                else
                    writer.WriteNull("price_close");

            if (oHLCVTimeseriesItem.VolumeTradedOption.IsSet)
                writer.WriteNumber("volume_traded", oHLCVTimeseriesItem.VolumeTradedOption.Value!.Value);

            if (oHLCVTimeseriesItem.TradesCountOption.IsSet)
                writer.WriteNumber("trades_count", oHLCVTimeseriesItem.TradesCountOption.Value!.Value);
        }
    }
}
