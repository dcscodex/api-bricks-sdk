...
part 'ohlcv_timeseries_period.g.dart';
...
@BuiltValue()
abstract class OHLCVTimeseriesPeriod implements Built<OHLCVTimeseriesPeriod, OHLCVTimeseriesPeriodBuilder> {
  ...
  OHLCVTimeseriesPeriod._();

  factory OHLCVTimeseriesPeriod([void updates(OHLCVTimeseriesPeriodBuilder b)]) = _$OHLCVTimeseriesPeriod;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OHLCVTimeseriesPeriodBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OHLCVTimeseriesPeriod> get serializer => _$OHLCVTimeseriesPeriodSerializer();
}

class _$OHLCVTimeseriesPeriodSerializer implements PrimitiveSerializer<OHLCVTimeseriesPeriod> {
  @override
  final Iterable<Type> types = const [OHLCVTimeseriesPeriod, _$OHLCVTimeseriesPeriod];

  @override
  final String wireName = r'OHLCVTimeseriesPeriod';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OHLCVTimeseriesPeriod object, {
  ...
  void _deserializeProperties(
    ...
    required OHLCVTimeseriesPeriodBuilder result,
  ...
  @override
  OHLCVTimeseriesPeriod deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OHLCVTimeseriesPeriodBuilder();
