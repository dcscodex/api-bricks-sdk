...
v1_ohlcv_exchange_exchange_id_history_get(ExchangeId, PeriodId, TimeStart, TimeEnd) ->
  openapi_api:v1_ohlcv_exchange_exchange_id_history_get(ExchangeId, PeriodId, TimeStart, TimeEnd).

v1_ohlcv_exchange_exchange_id_history_get_args(_S) ->
...
v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get(ExchangeId, SymbolId, PeriodId) ->
  openapi_api:v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get(ExchangeId, SymbolId, PeriodId).

v1_ohlcv_exchange_symbol_exchange_id_symbol_id_history_get_args(_S) ->
...
v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get(ExchangeId, SymbolId, PeriodId) ->
  openapi_api:v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get(ExchangeId, SymbolId, PeriodId).

v1_ohlcv_exchange_symbol_exchange_id_symbol_id_latest_get_args(_S) ->
  [binary(), binary(), binary()].
...
v1_ohlcv_periods_get() ->
  openapi_api:v1_ohlcv_periods_get().

v1_ohlcv_periods_get_args(_S) ->
  [].
