...
-- | display the config
instance P.Show RESTConfig where
  show c =
    T.printf
...
-- | constructs a default RESTConfig
--
-- configHost:
--
...
addAuthMethod :: AuthMethod auth => RESTConfig -> auth -> RESTConfig
addAuthMethod config@RESTConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: RESTConfig -> IO RESTConfig
...
withStderrLogging :: RESTConfig -> IO RESTConfig
...
withNoLogging :: RESTConfig -> RESTConfig
...
data RESTRequest req contentType res accept = RESTRequest
  { rMethod  :: NH.Method   -- ^ Method of RESTRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of RESTRequest
  , rParams   :: Params -- ^ params of RESTRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (RESTRequest req contentType res accept) NH.Method
rMethodL f RESTRequest{..} = (\rMethod -> RESTRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (RESTRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f RESTRequest{..} = (\rUrlPath -> RESTRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (RESTRequest req contentType res accept) Params
rParamsL f RESTRequest{..} = (\rParams -> RESTRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (RESTRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f RESTRequest{..} = (\rAuthTypes -> RESTRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => RESTRequest req contentType res accept -> param -> RESTRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: RESTRequest req contentType res accept -> param -> RESTRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: RESTRequest req contentType res accept -> param -> RESTRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
_mkRequest :: NH.Method -- ^ Method
          ...
          -> RESTRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = RESTRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     RESTRequest req contentType res accept
  -> [NH.Header]
  -> RESTRequest req contentType res accept
...
removeHeader :: RESTRequest req contentType res accept -> [NH.HeaderName] -> RESTRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => RESTRequest req contentType res accept -> RESTRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => RESTRequest req contentType res accept -> RESTRequest req contentType res accept
...
addForm :: RESTRequest req contentType res accept -> WH.Form -> RESTRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: RESTRequest req contentType res accept -> NH.Part -> RESTRequest req contentType res accept
...
_setBodyBS :: RESTRequest req contentType res accept -> B.ByteString -> RESTRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: RESTRequest req contentType res accept -> BL.ByteString -> RESTRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => RESTRequest req contentType res accept -> P.Proxy authMethod -> RESTRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> RESTRequest req contentType res accept
    -> IO (RESTRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> RESTConfig
  -> IO (RESTRequest req contentType res accept)
_applyAuthMethods req config@(RESTConfig {configAuthMethods = as}) =
  foldlM go req as
  where
