...
class TestLevel3ExecutedOrderModel(unittest.TestCase):
    """Level3ExecutedOrderModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Level3ExecutedOrderModel:
        ...
        """
        model = Level3ExecutedOrderModel()
        if include_optional:
    ...
    def testLevel3ExecutedOrderModel(self):
        """Test Level3ExecutedOrderModel"""
