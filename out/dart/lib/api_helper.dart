...
String parameterToString(dynamic value) {
  ...
  if (value is DTOExtractorType) {
    return DTOExtractorTypeTypeTransformer().encode(value).toString();
  }
  if (value is DTOFilingSortBy) {
    return DTOFilingSortByTypeTransformer().encode(value).toString();
  }
