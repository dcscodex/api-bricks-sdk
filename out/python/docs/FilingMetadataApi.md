# openapi_client.FilingMetadataApi
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.FilingMetadataApi(api_client)
    ...
    sort_by = openapi_client.DTOFilingSortBy() # DTOFilingSortBy | Field to sort results by (default: AccessionNumber) (optional)
